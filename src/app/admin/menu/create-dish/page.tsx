...
export default function CreateDish() {
  ...
  return (
    <main className={"flex flex-col items-center"}>
      <h1 className={"mb-10 text-center text-xl"}>Nieuw Gerecht</h1>

      <form className={"flex flex-col"}>
        <Input label={"Categorie naam"} id={"name"} />
        <Input label={"Beschrijving"} id={"description"} />
        <Input label={"Prijs"} id={"price"} />
        ...
        <Button>Maak gerecht aan</Button>
      </form>
    </main>
  );
}
